...
Al usuario lo representamos en ese mismo espacio. Del historial tomamos el centroide —el promedio de las distribuciones de tópicos de lo que vio— y lo promediamos con la distribución de su query. Es la misma idea de promediar vectores que vimos en la Unidad 4, acá aplicada a distribuciones de tópicos: las dos fuentes entran con el mismo peso, sin nada que ajustar a mano. Después recomendamos por similitud de coseno en el espacio de tópicos, sacando lo que ya vio. Les paso la palabra para ver cómo da esto.
